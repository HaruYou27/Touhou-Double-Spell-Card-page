...
/** @type {string} */
const CACHE_VERSION = '1738854442|234650655';
/** @type {string} */
const CACHE_PREFIX = 'Touhou Double Sp-sw-cache-';
...
/** @type {string[]} */
const CACHABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libBulletHELLplusplus.web.template_release.wasm32.wasm"];
